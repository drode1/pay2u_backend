# Generated by Django 4.2 on 2024-03-26 08:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'patronymic',
                    models.CharField(max_length=20, verbose_name='Patronymic'),
                ),
                (
                    'notification_date',
                    models.DateField(auto_now=True, verbose_name='Notification date'),
                ),
                (
                    'phone',
